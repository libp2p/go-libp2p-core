...
type PeerRecord struct {
	...
	// metric is an index of preference for a node. The default is 100, where lower numbers are
	// preferred. For instance, a node using low-power mode or on a metered network should raise
	// this higher, while a dedicated server may want to lower this. If multiple have the same
	// metric then one should be picked randomly.
...
func (m *PeerRecord) GetMetric() uint32 {
	if m != nil {
		return m.Metric
	}
	return 0
...
var fileDescriptor_dc0d8059ab0ad14d = []byte{
	...
	0x09, 0xe9, 0x15, 0x24, 0x29, 0xed, 0x66, 0xe4, 0xe2, 0x0a, 0x48, 0x4d, 0x2d, 0x0a, 0x02, 0xcb,
	...
	0x47, 0x88, 0x22, 0xcf, 0xbc, 0xb4, 0xfc, 0x20, 0x84, 0x0e, 0x21, 0x31, 0x2e, 0xb6, 0xdc, 0xd4,
	0x92, 0xa2, 0xcc, 0x64, 0x09, 0x16, 0x05, 0x46, 0x0d, 0xde, 0x20, 0x28, 0x4f, 0x4a, 0x9b, 0x8b,
	0x1b, 0x49, 0x87, 0x90, 0x0c, 0x17, 0x67, 0x6e, 0x69, 0x4e, 0x49, 0x26, 0x48, 0x23, 0xd4, 0x49,
	0x08, 0x01, 0x27, 0x89, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e,
	0x71, 0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x48, 0x62, 0x03,
	0xfb, 0xd3, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x34, 0xe5, 0x2a, 0x88, 0xfc, 0x00, 0x00, 0x00,
}
...
func (m *PeerRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Metric != 0 {
		i = encodeVarintPeerRecord(dAtA, i, uint64(m.Metric))
		i--
		dAtA[i] = 0x20
	}
...
func (m *PeerRecord) Size() (n int) {
	...
	if m.Metric != 0 {
		n += 1 + sovPeerRecord(uint64(m.Metric))
	}
	return n
}
