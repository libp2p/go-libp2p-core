...
type Runtime_EventProperty_PropertyType int32

const (
	// treat as a simple primitive
	Runtime_EventProperty_STRING Runtime_EventProperty_PropertyType = 0
	Runtime_EventProperty_NUMBER Runtime_EventProperty_PropertyType = 2
	// apply human-readable formatting
	Runtime_EventProperty_TIME   Runtime_EventProperty_PropertyType = 10
	Runtime_EventProperty_PEERID Runtime_EventProperty_PropertyType = 11
	// embedded arrays and/or object trees
	Runtime_EventProperty_JSON Runtime_EventProperty_PropertyType = 90
)

var Runtime_EventProperty_PropertyType_name = map[int32]string{
	0:  "STRING",
	2:  "NUMBER",
	10: "TIME",
	11: "PEERID",
...
var Runtime_EventProperty_PropertyType_value = map[string]int32{
	"STRING": 0,
	"NUMBER": 2,
	"TIME":   10,
	"PEERID": 11,
...
func (x Runtime_EventProperty_PropertyType) String() string {
	return proto.EnumName(Runtime_EventProperty_PropertyType_name, int32(x))
}

func (Runtime_EventProperty_PropertyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_53a8bedf9a75e10a, []int{4, 1, 0}
}
...
const (
	...
	ClientSignal_START_PUSH_EMITTER   ClientSignal_Signal = 1
	ClientSignal_STOP_PUSH_EMITTER    ClientSignal_Signal = 2
	ClientSignal_PAUSE_PUSH_EMITTER   ClientSignal_Signal = 3
	ClientSignal_UNPAUSE_PUSH_EMITTER ClientSignal_Signal = 4
	ClientSignal_CONFIG_EMITTER       ClientSignal_Signal = 10
)

var ClientSignal_Signal_name = map[int32]string{
	0:  "SEND_DATA",
	1:  "START_PUSH_EMITTER",
	2:  "STOP_PUSH_EMITTER",
	3:  "PAUSE_PUSH_EMITTER",
	4:  "UNPAUSE_PUSH_EMITTER",
	10: "CONFIG_EMITTER",
}
...
func (ClientSignal_Signal) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_53a8bedf9a75e10a, []int{15, 0}
}
...
func (ClientSignal_DataSource) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_53a8bedf9a75e10a, []int{15, 1}
}
...
type Runtime struct {
	...
	EventTypes []*Runtime_EventType `protobuf:"bytes,7,rep,name=event_types,json=eventTypes,proto3" json:"event_types,omitempty"`
}
...
func (m *Runtime) GetEventTypes() []*Runtime_EventType {
	if m != nil {
		return m.EventTypes
	}
	return nil
...
type Runtime_EventType struct {
	// Name of event type e.g. PeerConnecting
	Name       string                   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Properties []*Runtime_EventProperty `protobuf:"bytes,2,rep,name=properties,proto3" json:"properties,omitempty"`
}

func (m *Runtime_EventType) Reset()         { *m = Runtime_EventType{} }
func (m *Runtime_EventType) String() string { return proto.CompactTextString(m) }
func (*Runtime_EventType) ProtoMessage()    {}
func (*Runtime_EventType) Descriptor() ([]byte, []int) {
	return fileDescriptor_53a8bedf9a75e10a, []int{4, 0}
}
func (m *Runtime_EventType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Runtime_EventType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Runtime_EventType.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Runtime_EventType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Runtime_EventType.Merge(m, src)
}
func (m *Runtime_EventType) XXX_Size() int {
	return m.Size()
}
func (m *Runtime_EventType) XXX_DiscardUnknown() {
	xxx_messageInfo_Runtime_EventType.DiscardUnknown(m)
}

var xxx_messageInfo_Runtime_EventType proto.InternalMessageInfo

func (m *Runtime_EventType) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *Runtime_EventType) GetProperties() []*Runtime_EventProperty {
	if m != nil {
		return m.Properties
	}
	return nil
...
type Runtime_EventProperty struct {
	// property name of content e.g. openTs
	Name string                             `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Type Runtime_EventProperty_PropertyType `protobuf:"varint,2,opt,name=type,proto3,enum=introspection.Runtime_EventProperty_PropertyType" json:"type,omitempty"`
}

func (m *Runtime_EventProperty) Reset()         { *m = Runtime_EventProperty{} }
func (m *Runtime_EventProperty) String() string { return proto.CompactTextString(m) }
func (*Runtime_EventProperty) ProtoMessage()    {}
func (*Runtime_EventProperty) Descriptor() ([]byte, []int) {
	return fileDescriptor_53a8bedf9a75e10a, []int{4, 1}
}
func (m *Runtime_EventProperty) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Runtime_EventProperty) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Runtime_EventProperty.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Runtime_EventProperty) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Runtime_EventProperty.Merge(m, src)
}
func (m *Runtime_EventProperty) XXX_Size() int {
	return m.Size()
}
func (m *Runtime_EventProperty) XXX_DiscardUnknown() {
	xxx_messageInfo_Runtime_EventProperty.DiscardUnknown(m)
}

var xxx_messageInfo_Runtime_EventProperty proto.InternalMessageInfo

func (m *Runtime_EventProperty) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *Runtime_EventProperty) GetType() Runtime_EventProperty_PropertyType {
	if m != nil {
		return m.Type
	}
	return Runtime_EventProperty_STRING
}
...
type Connection_Timeline struct {
	...
	OpenTs *types.Timestamp `protobuf:"bytes,1,opt,name=open_ts,json=openTs,proto3" json:"open_ts,omitempty"`
	// the instant when the upgrade process (handshake, security, multiplexing) finished.
	UpgradedTs *types.Timestamp `protobuf:"bytes,2,opt,name=upgraded_ts,json=upgradedTs,proto3" json:"upgraded_ts,omitempty"`
...
func (m *Connection_Timeline) GetOpenTs() *types.Timestamp {
	if m != nil {
		return m.OpenTs
	}
	return nil
...
func (m *Connection_Timeline) GetUpgradedTs() *types.Timestamp {
	if m != nil {
		return m.UpgradedTs
	}
	return nil
...
func (m *Connection_Timeline) GetCloseTs() *types.Timestamp {
	if m != nil {
		return m.CloseTs
	}
	return nil
...
func (m *Stream_Timeline) GetOpenTs() *types.Timestamp {
	if m != nil {
		return m.OpenTs
	}
	return nil
...
func (m *Stream_Timeline) GetCloseTs() *types.Timestamp {
	if m != nil {
		return m.CloseTs
	}
	return nil
...
type DHT struct {
	...
	StartTs *types.Timestamp `protobuf:"bytes,3,opt,name=start_ts,json=startTs,proto3" json:"start_ts,omitempty"`
	// params of the dht.
...
func (m *DHT) GetStartTs() *types.Timestamp {
	if m != nil {
		return m.StartTs
	}
	return nil
...
func (*DHT_Bucket) Descriptor() ([]byte, []int) {
	return fileDescriptor_53a8bedf9a75e10a, []int{10, 2}
}
...
func (m *DHT_Bucket) GetDistance() uint32 {
	if m != nil {
		return m.Distance
	}
	return 0
...
func (*DHT_QueryGauge) Descriptor() ([]byte, []int) {
	return fileDescriptor_53a8bedf9a75e10a, []int{10, 3}
}
...
type State struct {
	...
	InstantTs *types.Timestamp `protobuf:"bytes,3,opt,name=instant_ts,json=instantTs,proto3" json:"instant_ts,omitempty"`
	// start of included data collection (cumulative values counted from here)
	StartTs *types.Timestamp `protobuf:"bytes,4,opt,name=start_ts,json=startTs,proto3" json:"start_ts,omitempty"`
...
func (m *Event) GetTs() *types.Timestamp {
	if m != nil {
		return m.Ts
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("introspection.Runtime_EventProperty_PropertyType", Runtime_EventProperty_PropertyType_name, Runtime_EventProperty_PropertyType_value)
	...
	proto.RegisterType((*Runtime_EventType)(nil), "introspection.Runtime.EventType")
	proto.RegisterType((*Runtime_EventProperty)(nil), "introspection.Runtime.EventProperty")
...
var fileDescriptor_53a8bedf9a75e10a = []byte{
	...
	,
}
...
func (m *Runtime_EventType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Runtime_EventType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Runtime_EventType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Runtime_EventProperty) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Runtime_EventProperty) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Runtime_EventProperty) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Connection_Timeline) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CloseTs != nil {
		{
			size, err := m.CloseTs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UpgradedTs != nil {
		{
			size, err := m.UpgradedTs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.OpenTs != nil {
		{
			size, err := m.OpenTs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DHT_Bucket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Distance != 0 {
		i = encodeVarintIntrospection(dAtA, i, uint64(m.Distance))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.InstantTs != nil {
		{
			size, err := m.InstantTs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Runtime_EventType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Runtime_EventProperty) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DHT_Bucket) Size() (n int) {
	...
	_ = l
	if m.Distance != 0 {
		n += 1 + sovIntrospection(uint64(m.Distance))
	}
	if len(m.Peers) > 0 {
...
func (m *Runtime) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.EventTypes = append(m.EventTypes, &Runtime_EventType{})
...
func (m *Runtime_EventType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			m.Properties = append(m.Properties, &Runtime_EventProperty{})
...
func (m *Runtime_EventProperty) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= Runtime_EventProperty_PropertyType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Connection_Timeline) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.OpenTs == nil {
				m.OpenTs = &types.Timestamp{}
			}
			if err := m.OpenTs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if m.UpgradedTs == nil {
				m.UpgradedTs = &types.Timestamp{}
			}
			if err := m.UpgradedTs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if m.CloseTs == nil {
				m.CloseTs = &types.Timestamp{}
			}
			if err := m.CloseTs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
